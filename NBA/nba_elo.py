...
# data format:
# home team, away team, date, home result
# sorted by dates

results_file = open("nba_games.csv",'r')
...
for row in results:
    home_team,away_team,date,home_result = row.split(',')
...
arr = [(team,ratings[team][-1]) for team in peak_ratings]
